    ...
    <ThemeProvider theme={theme}>
      <Router>
        ...
        <div className={classes.app}>
          <Switch>
            <Route path="/" exact component={() => <TitleContent handleSubmit={handleSubmit}></TitleContent>} />
            <Route path="/result" component={() => (
              <Loader loading={loading || data === undefined} render={()=>{
                debugger
                return hasError ? `An error happennned : ${errorMessage}` : <Result {...data} video={videoFile}></Result>
